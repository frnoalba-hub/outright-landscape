...
export const GEO_FAQS = {
  home: [
    { q: 'How much does a custom patio cost in Covina?', a: 'Custom paver patios in Covina typically range from $15–$30 per square foot depending on materials and complexity. Outright Landscape provides free on-site estimates with detailed pricing for patios, walkways, and driveways in the San Gabriel Valley.' },
    { q: 'Are you licensed and insured for landscaping work?', a: 'Yes. Outright Landscape holds CSLB license #1073845 (C-27 Landscaping Contractor) and is fully bonded and insured. We serve Covina, Glendora, San Dimas, and the entire San Gabriel Valley.' },
    { q: 'Do you offer landscaping maintenance near me?', a: 'We offer landscape construction including new installations, irrigation repair, and hardscaping. For ongoing maintenance, we recommend seasonal tune-ups—call (626) 343-6028 to discuss your property and service area in the San Gabriel Valley.' },
    { q: 'What areas do you serve?', a: 'We serve Covina, Glendora, San Dimas, West Covina, Pasadena, La Verne, Claremont, Diamond Bar, Azusa, and 20+ cities across the San Gabriel Valley. Free estimates available for all service areas.' },
  ],
  irrigation: [
    { q: 'How much does sprinkler installation cost in the San Gabriel Valley?', a: 'Sprinkler installation typically starts at $1,000 and can range to $6,000+ depending on yard size and zones. We provide free on-site estimates for Covina, Glendora, San Dimas, and surrounding cities.' },
    { q: 'Are you licensed and insured for irrigation repair?', a: 'Yes. Outright Landscape holds CSLB #1073845 and is fully licensed, bonded, and insured for all irrigation and sprinkler work. Same-day emergency repair available in the San Gabriel Valley.' },
    { q: 'Do you offer sprinkler repair near me?', a: 'We serve the entire San Gabriel Valley including Covina, Glendora, San Dimas, La Verne, West Covina, and Pasadena. Call (626) 343-6028 for same-day service on sprinkler leaks and valve issues.' },
  ...
  hardscape: [
    { q: 'How much does a custom patio cost in Covina?', a: 'Paver patios in Covina typically run $15–$30 per square foot. Concrete driveways range $8–$18 per square foot. We provide free on-site estimates with detailed breakdowns for patios, driveways, and retaining walls.' },
    { q: 'Are you licensed for hardscape work?', a: 'Yes. Outright Landscape holds CSLB license #1073845 (C-27 Landscaping Contractor), which covers all hardscape, paver, concrete, and retaining wall work in California.' },
    { q: 'Do you do concrete and paver work near me?', a: 'We serve Covina, Glendora, San Dimas, Pasadena, West Covina, Diamond Bar, La Verne, Walnut, Pomona, and the full San Gabriel Valley. Call (626) 343-6028 for a free estimate.' },
    { q: 'How long does paver installation take?', a: 'Most residential paver projects are completed in 2–5 days depending on size. We handle demolition, base prep, paver placement, and sealing—all included in our upfront estimate.' },
  ],
};
