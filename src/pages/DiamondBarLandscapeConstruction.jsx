...
const services = [
  { icon: Wrench, title: "Landscape Construction & Design" },
  { icon: Droplets, title: "Sprinkler Installation & Repair" },
  { icon: Sprout, title: "Sod Installation (Marathon tall fescue, Bermuda)" },
  { icon: Hammer, title: "Hardscape Installation (pavers, patios, retaining walls)" },
  { icon: Leaf, title: "Mulching Services" },
  { icon: Zap, title: "Decorative Rock & Lighting Installations" },
  { icon: Truck, title: "Cleanup & Demolition" },
];

const whyUsItems = [
  "Local knowledge of soil & weather",
  "Licensed & insured",
  "Honest, competitive pricing",
  "Quality materials"
];

export default function DiamondBarLandscapeConstructionPage() {
  const [formData, setFormData] = useState({
    name: "", phone: "", email: "", city: "Diamond Bar", message: "", company: ""
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isSubmitted, setIsSubmitted] = useState(false);

  useEffect(() => {
    document.title = "Diamond Bar Landscape Construction | Outright Landscape Construction";
    
    const metaDescriptionEl = document.querySelector('meta[name="description"]');
    const metaDescriptionContent = "Expert landscaping, hardscaping, and sprinkler installation in Diamond Bar, CA. Licensed, insured, and locally trusted.";
    ...
    const pageUrl = "https://outrightlandscape.com/diamond-bar-landscape-construction";
    ...
    try {
      ...
      if (!formData.company) {
        const payload = new URLSearchParams({
          _subject: `New Quote Request — Diamond Bar`,
          name: formData.name,
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="hero relative text-white text-center flex flex-col items-center justify-center min-h-[60vh] py-20 px-4">
        ...
        <div className="relative z-10 flex flex-col items-center gap-y-4">
          <h1 className="hero-h1 text-4xl md:text-6xl font-extrabold leading-tight">
            Diamond Bar Landscape Construction & Landscaping Services
          </h1>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Diamond Bar's Trusted Landscape Construction Experts</h2>
          <p className="mt-6 text-lg text-gray-700 leading-relaxed">
            At Outright Landscape Construction, we bring years of expertise to homeowners and businesses in Diamond Bar. 
            As a licensed and insured contractor (CA CSLB #1073845), we deliver premium landscapes built to last.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Our Landscape & Hardscape Services in Diamond Bar</h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold">Why Diamond Bar Chooses Us</h2>
            </div>
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Proudly Serving</h2>
          <p className="text-lg text-gray-700">
            Diamond Bar, Covina, West Covina, Glendora, Pasadena, Charter Oak, San Dimas, La Verne, Claremont, Baldwin Park
          </p>
        </div>
      </section>
