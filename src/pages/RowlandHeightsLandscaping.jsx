...
const services = [
  { icon: Sprout, title: "Sod Installation Rowland Heights", description: "Premium turf.", keywords: "sod, turf" },
  { icon: Hammer, title: "Hardscaping Rowland Heights", description: "Expert pavers.", keywords: "hardscaping" },
  { icon: Droplets, title: "Irrigation Rowland Heights", description: "Professional irrigation.", keywords: "irrigation" },
  { icon: Award, title: "Landscape Design Rowland Heights", description: "Complete design.", keywords: "design" }
];

const projects = [
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/bbdea4e3f_2025-05-281.jpg", title: "Sod Installation", description: "Lush lawn", alt: "Outright Landscape – Sod Installation in Rowland Heights" },
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/670c050ff_2025-05-284.jpg", title: "Paver Patio", description: "Custom hardscaping", alt: "Outright Landscape – Paver Patio in Rowland Heights" },
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/805f8b55a_2025-05-282.jpg", title: "Irrigation", description: "Professional system", alt: "Outright Landscape – Irrigation in Rowland Heights" }
];

export default function RowlandHeightsLandscaping() {
  const [formData, setFormData] = useState({ name: "", phone: "", email: "", city: "Rowland Heights", message: "", service_type: "landscaping" });
  ...
  const trackPhoneClick = (location) => {
    if (window.dataLayer) {
      window.dataLayer.push({
        ...
        event_label: `rowland_heights_${location}`,
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Outright Landscape - Rowland Heights",
    ...
    "address": { "@type": "PostalAddress", "addressLocality": "Rowland Heights", "addressRegion": "CA", "postalCode": "91748", "addressCountry": "US" },
    "geo": { "@type": "GeoCoordinates", "latitude": 33.9761, "longitude": -117.9053 },
    "url": "https://outrightlandscape.com/rowland-heights-landscaping",
    "priceRange": "$$",
    "areaServed": { "@type": "City", "name": "Rowland Heights" }
  };

  const breadcrumbItems = [
    { name: "Home", url: "https://outrightlandscape.com" },
    { name: "Service Areas", url: "https://outrightlandscape.com/#service-areas" },
    { name: "Rowland Heights Landscaping", url: "https://outrightlandscape.com/rowland-heights-landscaping" }
  ];

  return (
    <div className="bg-white">
      <SEO 
        title="Rowland Heights Landscape Construction & Landscaping Services | Outright Landscape"
        description="Professional landscaping, concrete, and paver work across Rowland Heights and nearby areas. Call now for a free AI design preview and same-week quote."
        keywords="landscaping Rowland Heights, sod installation Rowland Heights, hardscaping Rowland Heights, landscape contractor Rowland Heights, CSLB 1073845, AI design preview"
        canonicalUrl="https://outrightlandscape.com/rowland-heights-landscaping"
      ...
      <SharedHero 
        ...
        subtitle="Licensed C-27 landscape contractor serving Rowland Heights & the San Gabriel Valley"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Sod Installation Rowland Heights</h2></div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Hardscaping Rowland Heights</h2></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold text-gray-900 mb-8">Also Serving Nearby Communities</h2>
          <div className="flex flex-wrap justify-center gap-4">{[{ name: 'Diamond Bar', page: 'DiamondBarLandscaping' }, { name: 'Walnut', page: 'WalnutLandscaping' }, { name: 'Pomona', page: 'PomonaLandscaping' }, { name: 'San Gabriel Valley', page: 'SanGabrielValleyLandscaping' }].map(city => (<a key={city.name} href={createPageUrl(city.page)} className="group"><div className="bg-white hover:bg-green-500 border-2 border-gray-200 hover:border-green-500 transition-all duration-300 rounded-xl px-6 py-3 group-hover:scale-105 group-hover:shadow-lg"><span className="font-semibold text-gray-700 group-hover:text-white transition-colors flex items-center gap-2">{city.name}<ArrowRight className="w-4 h-4" /></span></div></a>))}</div>
        </div>
      </section>

      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8"><h2 className="text-3xl font-bold text-gray-900 mb-4">Visit Our Rowland Heights Location</h2></div>
          <div className="rounded-2xl overflow-hidden shadow-xl">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106167.77073!2d-117.9053!3d33.9761!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2d7c8f7e3b6e5%3A0x3e5e5f8e7f8e7f8e!2sRowland%20Heights%2C%20CA!5e0!3m2!1sen!2sus!4v1234567890" width="100%" height="450" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Outright Landscape Rowland Heights Location"></iframe>
          </div>
        </div>
      </section>
