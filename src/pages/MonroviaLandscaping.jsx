...
const services = [
  { icon: Award, title: "Landscape Design Monrovia", description: "Custom landscape design.", keywords: "landscape design" },
  { icon: Sprout, title: "Sod Installation Monrovia", description: "Premium turf installation.", keywords: "sod, turf" },
  { icon: Hammer, title: "Hardscaping Monrovia", description: "Expert paver work.", keywords: "hardscaping, pavers" },
  { icon: Droplets, title: "Irrigation Monrovia", description: "Professional irrigation.", keywords: "irrigation" }
];

const projects = [
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/bbdea4e3f_2025-05-281.jpg", title: "Sod Installation", description: "Lush lawn", alt: "Outright Landscape – Sod Installation in Monrovia" },
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/670c050ff_2025-05-284.jpg", title: "Paver Patio", description: "Custom hardscaping", alt: "Outright Landscape – Paver Patio in Monrovia" },
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/805f8b55a_2025-05-282.jpg", title: "Irrigation", description: "Professional system", alt: "Outright Landscape – Irrigation in Monrovia" }
];

export default function MonroviaLandscaping() {
  const [formData, setFormData] = useState({ name: "", phone: "", email: "", city: "Monrovia", message: "", service_type: "landscaping" });
  ...
  const trackPhoneClick = (location) => {
    if (typeof window !== 'undefined' && window.dataLayer) {
      window.dataLayer.push({
        ...
        event_label: `monrovia_${location}`,
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Outright Landscape - Monrovia",
    ...
    "address": { "@type": "PostalAddress", "addressLocality": "Monrovia", "addressRegion": "CA", "postalCode": "91016", "addressCountry": "US" },
    "geo": { "@type": "GeoCoordinates", "latitude": 34.1442, "longitude": -118.0019 },
    "url": "https://outrightlandscape.com/monrovia-landscaping",
    "priceRange": "$$",
    "areaServed": { "@type": "City", "name": "Monrovia" }
  };

  const breadcrumbItems = [
    { name: "Home", url: "https://outrightlandscape.com" },
    { name: "Service Areas", url: "https://outrightlandscape.com/#service-areas" },
    { name: "Monrovia Landscaping", url: "https://outrightlandscape.com/monrovia-landscaping" }
  ];

  return (
    <div className="bg-white">
      <SEO 
        title="Monrovia Landscape Construction & Landscaping Services | Outright Landscape"
        description="Professional landscaping, concrete, and paver work across Monrovia and nearby areas. Call now for a free AI design preview and same-week quote."
        keywords="landscaping Monrovia, sod installation Monrovia, hardscaping Monrovia, landscape contractor Monrovia, CSLB 1073845, AI design preview"
        canonicalUrl="https://outrightlandscape.com/monrovia-landscaping"
      ...
      <SharedHero 
        ...
        subtitle="Licensed C-27 landscape contractor serving Monrovia & the San Gabriel Valley"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Landscape Design Monrovia</h2></div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Hardscaping Monrovia</h2></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold text-gray-900 mb-8">Also Serving Nearby Communities</h2>
          <div className="flex flex-wrap justify-center gap-4">{[{ name: 'Arcadia', page: 'ArcadiaLandscaping' }, { name: 'Duarte', page: 'DuarteLandscaping' }, { name: 'Pasadena', page: 'PasadenaLandscaping' }, { name: 'San Gabriel Valley', page: 'SanGabrielValleyLandscaping' }].map(city => (<a key={city.name} href={createPageUrl(city.page)} className="group"><div className="bg-white hover:bg-green-500 border-2 border-gray-200 hover:border-green-500 transition-all duration-300 rounded-xl px-6 py-3 group-hover:scale-105 group-hover:shadow-lg"><span className="font-semibold text-gray-700 group-hover:text-white transition-colors flex items-center gap-2">{city.name}<ArrowRight className="w-4 h-4" /></span></div></a>))}</div>
        </div>
      </section>

      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8"><h2 className="text-3xl font-bold text-gray-900 mb-4">Visit Our Monrovia Location</h2></div>
          <div className="rounded-2xl overflow-hidden shadow-xl">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106167.77073!2d-118.0019!3d34.1442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2d7c8f7e3b6e5%3A0x3e5e5f8e7f8e7f8e!2sMonrovia%2C%20CA!5e0!3m2!1sen!2sus!4v1234567890" width="100%" height="450" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Outright Landscape Monrovia Location"></iframe>
          </div>
        </div>
      </section>
