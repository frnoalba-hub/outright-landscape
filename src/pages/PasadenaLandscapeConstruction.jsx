...
const services = [
  ...
  { icon: Droplets, title: "Sprinkler Installation & Repair", description: "Keep your lawn healthy year-round with efficient irrigation systems, including drip and automatic sprinklers, designed for Pasadena's climate." },
...
const whyUsItems = [
  "Local knowledge of Pasadena's soil, plants, and weather patterns",
  "Licensed & insured for your peace of mind",
  "Honest, competitive pricing with free estimates",
  "Quality materials for long-lasting results"
];

export default function PasadenaLandscapeConstructionPage() {
  const [formData, setFormData] = useState({
    name: "", phone: "", email: "", city: "Pasadena", message: "", company: ""
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isSubmitted, setIsSubmitted] = useState(false);

  useEffect(() => {
    document.title = "Pasadena Landscape Construction | Outright Landscape Construction";
    
    const metaDescriptionEl = document.querySelector('meta[name="description"]');
    const metaDescriptionContent = "Outright Landscape Construction provides expert landscaping, hardscaping, and sprinkler installation in Pasadena, CA. Licensed, insured, and local.";
    ...
    const pageUrl = "https://outrightlandscape.com/pasadena-landscape-construction";
    ...
    const schema = {
      ...
      "areaServed": ["Pasadena", "Covina", "West Covina", "Glendora", "Azusa", "Diamond Bar", "Charter Oak", "La Verne"],
    ...
    try {
      ...
      if (!formData.company) {
        const payload = new URLSearchParams({
          _subject: `New Quote Request — Pasadena`,
          name: formData.name,
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="hero relative text-white text-center flex flex-col items-center justify-center min-h-[60vh] py-20 px-4">
        ...
        <div className="relative z-10 flex flex-col items-center gap-y-4">
          <h1 className="hero-h1 text-4xl md:text-6xl font-extrabold leading-tight">
            Pasadena Landscape Construction & Landscaping Services
          </h1>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Pasadena's Trusted Landscape Construction Experts</h2>
          <p className="mt-6 text-lg text-gray-700 leading-relaxed">
            At Outright Landscape Construction, we're proud to serve Pasadena and its surrounding communities. 
            As a licensed and insured contractor (CA CSLB #1073845), we've been transforming outdoor spaces for 
            homeowners and businesses in Pasadena for years. Our team blends expert craftsmanship with a personal 
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Our Landscape & Hardscape Services in Pasadena</h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold">Why Pasadena Chooses Outright Landscape Construction</h2>
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Proudly Serving Pasadena & Surrounding Communities</h2>
          <p className="text-lg text-gray-700">
            While we specialize in Pasadena, we also serve:<br />
      ...
      <section id="contact" className="py-20 md:py-28 bg-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-300">Transform your outdoor space with Pasadena's landscape experts.</p>
          </div>
