                                            ...
                                            <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 flex flex-col h-full">
                                                ...
                                                <div className="mt-auto pt-4 border-t border-blue-200">
                                                    {page.path.includes("city=") ? (
                                                        config.ai_suggestions?.includes("✅ Auto-Fixed") ? (
                                                            <div className="w-full py-2 bg-green-50 text-green-700 border border-green-200 text-sm font-semibold text-center rounded-md flex items-center justify-center gap-2">
                                                                <Check className="w-4 h-4" /> Content Updated
                                                            </div>
                                                        ) : (
                                                            <Button 
                                                                size="sm" 
