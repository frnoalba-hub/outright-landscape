...
export default function LaVerneLandscapeConstructionPage() {
  const [formData, setFormData] = useState({
    name: "", phone: "", email: "", city: "La Verne", message: "", company: ""
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isSubmitted, setIsSubmitted] = useState(false);

  useEffect(() => {
    document.title = "La Verne Landscape Construction | Outright Landscape Construction";
    
    const metaDescriptionEl = document.querySelector('meta[name="description"]');
    const metaDescriptionContent = "Transform your outdoor space with expert landscaping and hardscape installation in La Verne, CA.";
    ...
    const pageUrl = "https://outrightlandscape.com/la-verne-landscape-construction";
    ...
    try {
      ...
      if (!formData.company) {
        const payload = new URLSearchParams({
          _subject: `New Quote Request — La Verne`,
          name: formData.name,
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="hero relative text-white text-center flex flex-col items-center justify-center min-h-[60vh] py-20 px-4">
        ...
        <div className="relative z-10 flex flex-col items-center gap-y-4">
          <h1 className="hero-h1 text-4xl md:text-6xl font-extrabold leading-tight">
            La Verne Landscape Construction & Landscaping Services
          </h1>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">La Verne's Trusted Landscape Construction Experts</h2>
          <p className="mt-6 text-lg text-gray-700 leading-relaxed">
            At Outright Landscape Construction, we bring years of expertise to homeowners and businesses in La Verne. 
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Our Landscape & Hardscape Services in La Verne</h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold">Why La Verne Chooses Us</h2>
            </div>
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700">
            La Verne, Covina, West Covina, Glendora, Pasadena, Diamond Bar, Charter Oak, San Dimas, Claremont, Baldwin Park
          </p>
        </div>
      </section>
