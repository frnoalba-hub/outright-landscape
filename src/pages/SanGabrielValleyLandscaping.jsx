...
import { CheckCircle2, Phone, MapPin, Sprout, Hammer, Droplets, Award, Sparkles, ArrowRight } from "lucide-react";
...
const services = [
  { icon: Sprout, title: "Sod Installation San Gabriel Valley", description: "Premium turf installation services.", keywords: "sod installation, turf" },
  { icon: Hammer, title: "Hardscaping San Gabriel Valley", description: "Expert paver patios and walkways.", keywords: "hardscaping, pavers" },
  { icon: Droplets, title: "Irrigation San Gabriel Valley", description: "Professional sprinkler systems.", keywords: "irrigation, sprinklers" },
  { icon: Award, title: "Landscape Design San Gabriel Valley", description: "Complete landscape design services.", keywords: "landscape design" }
];

const projects = [
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/cdeefde95_2024-09-14.jpg", title: "Complete Landscape", description: "Full transformation", alt: "Outright Landscape – Complete Landscape in San Gabriel Valley" },
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/670c050ff_2025-05-284.jpg", title: "Paver Patio", description: "Custom hardscaping", alt: "Outright Landscape – Paver Patio in San Gabriel Valley" },
  { image: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/688d77e918e168a3b8c3aaa2/bbdea4e3f_2025-05-281.jpg", title: "Sod Installation", description: "Lush lawn", alt: "Outright Landscape – Sod Installation in San Gabriel Valley" }
];

export default function SanGabrielValleyLandscaping() {
  const [formData, setFormData] = useState({ name: "", phone: "", email: "", city: "San Gabriel Valley", message: "", service_type: "landscaping" });
  ...
  const trackPhoneClick = (location) => {
    if (typeof window !== 'undefined' && window.dataLayer) {
      window.dataLayer.push({
        ...
        event_label: `san_gabriel_valley_${location}`,
  ...
  const localBusinessSchema = {
    ...
    "@type": "LocalBusiness",
    "name": "Outright Landscape - San Gabriel Valley",
    ...
    "url": "https://outrightlandscape.com/san-gabriel-valley-landscaping",
    "priceRange": "$$",
    "areaServed": [
  ...
  const breadcrumbItems = [
    ...
    { name: "San Gabriel Valley Landscaping", url: "https://outrightlandscape.com/san-gabriel-valley-landscaping" }
  ];

  return (
    <div className="bg-white">
      <SEO 
        title="San Gabriel Valley Landscape Construction & Landscaping Services | Outright Landscape"
        description="Professional landscaping, concrete, and paver work across the San Gabriel Valley and nearby areas. Call now for a free AI design preview and same-week quote."
        keywords="landscaping San Gabriel Valley, sod installation San Gabriel Valley, hardscaping San Gabriel Valley, landscape contractor San Gabriel Valley, CSLB 1073845, AI design preview"
        canonicalUrl="https://outrightlandscape.com/san-gabriel-valley-landscaping"
      ...
      <SharedHero 
        ...
        subtitle="Licensed C-27 landscape contractor serving the entire San Gabriel Valley"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Sod Installation San Gabriel Valley</h2><p className="text-xl text-gray-600 max-w-3xl mx-auto">From premium sod to complete landscape design</p></div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Hardscaping San Gabriel Valley</h2></div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl font-bold text-gray-900 mb-8">Cities We Serve in San Gabriel Valley</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8"><h2 className="text-3xl font-bold text-gray-900 mb-4">Serving All of San Gabriel Valley</h2></div>
          <div className="rounded-2xl overflow-hidden shadow-xl">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d423673.91!2d-118.09!3d34.09!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80c2d7c8f7e3b6e5%3A0x3e5e5f8e7f8e7f8e!2sSan%20Gabriel%20Valley%2C%20CA!5e0!3m2!1sen!2sus!4v1234567890" width="100%" height="450" style={{ border: 0 }} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Outright Landscape San Gabriel Valley Location"></iframe>
          </div>
        </div>
      </section>
