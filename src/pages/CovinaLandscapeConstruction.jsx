...
import { CheckCircle, Phone, Text, MapPin, Wrench, Droplets, Sprout, Hammer, Leaf, Zap, Truck } from "lucide-react";
...
const services = [
  ...
  { icon: Droplets, title: "Sprinkler Installation & Repair", description: "Keep your lawn healthy year-round with efficient irrigation systems, including drip and automatic sprinklers, designed for Covina's climate." },
...
const whyUsItems = [
  "Local knowledge of Covina's soil, plants, and weather patterns",
  "Licensed & insured for your peace of mind",
  "Honest, competitive pricing with free estimates",
  "Quality materials for long-lasting results"
];

export default function CovinaLandscapeConstructionPage() {
  const [formData, setFormData] = useState({
    name: "", phone: "", email: "", city: "Covina", message: "", company: ""
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isSubmitted, setIsSubmitted] = useState(false);

  useEffect(() => {
    document.title = "Covina Landscape Construction | Outright Landscape Construction";
    
    const metaDescriptionEl = document.querySelector('meta[name="description"]');
    const metaDescriptionContent = "Outright Landscape Construction provides expert landscaping, hardscaping, and sprinkler installation in Covina, CA. Licensed, insured, and local.";
    ...
    const pageUrl = "https://outrightlandscape.com/covina-landscape-construction";
    ...
    const schema = {
      ...
      "areaServed": ["Covina", "West Covina", "Glendora", "Azusa", "Pasadena", "Diamond Bar", "Charter Oak", "La Verne"],
    ...
    try {
      ...
      if (!formData.company) {
        const payload = new URLSearchParams({
          _subject: `New Quote Request — Covina Landscape Construction`,
          name: formData.name,
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      {/* Hero */}
      <section className="hero relative text-white text-center flex flex-col items-center justify-center min-h-[50vh] py-16 px-4">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url('https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/4a1ab0c5a_o.jpg')",
          }}
        />
        <div className="relative z-10 flex flex-col items-center gap-y-4">
          <h1 className="hero-h1 text-3xl md:text-5xl font-extrabold leading-tight">
            Covina Landscape Construction & Landscaping Services
          </h1>
          <Button
            size="lg"
            onClick={() => handleScrollToSection("contact")}
            className="mt-4 bg-green-600 hover:bg-green-700 text-white font-bold text-xl px-12 py-6 rounded-full shadow-2xl transform hover:scale-105 transition-transform duration-300"
          >
            Request a Quote
          </Button>
          ...
          <p className="mt-3 px-4 py-1 bg-black/50 rounded-md text-sm font-semibold text-gray-200 border border-gray-500">
            CA CSLB #1073845
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
            Covina's Trusted Landscape Construction Experts
          </h2>
          <div className="text-lg text-gray-700 leading-relaxed space-y-4">
            <p>
              At Outright Landscape Construction, we're proud to call Covina home. As a licensed and insured contractor (CA CSLB #1073845), we've been transforming outdoor spaces for homeowners and businesses in Covina for years. Our team blends expert craftsmanship with a personal touch to deliver landscapes that are both beautiful and built to last.
            </p>
            <p>
              Whether you're looking to install a brand-new lawn, upgrade your hardscape, or completely redesign your yard, we handle it all with precision, professionalism, and local expertise.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">
              Our Landscape & Hardscape Services in Covina
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-gray-50 rounded-2xl p-6 shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
              >
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold">
              Why Covina Chooses Outright Landscape Construction
            </h2>
          </div>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {whyUsItems.map((item, index) => (
              <li key={index} className="flex items-start">
                <CheckCircle className="w-6 h-6 mr-3 mt-1 text-green-400 flex-shrink-0" />
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">
            Proudly Serving Covina & Surrounding Communities
          </h2>
          <div className="text-lg text-gray-700 leading-relaxed">
            <p className="mb-4">While Covina is our home base, we also serve:</p>
            <p className="font-semibold">
              West Covina • Glendora • Azusa • Pasadena • Diamond Bar • Charter Oak • San Dimas • La Verne • Claremont • Baldwin Park
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-300">
              Transform your outdoor space with Covina's landscape experts.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-4 p-5">
                ...
                <div>
                  <p className="font-bold text-xl">Serving Covina & Nearby Areas</p>
                  <p className="text-gray-300">Your local landscaping experts</p>
                </div>
              </div>
            </div>
