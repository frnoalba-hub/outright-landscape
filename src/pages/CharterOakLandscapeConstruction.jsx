...
export default function CharterOakLandscapeConstructionPage() {
  const [formData, setFormData] = useState({
    name: "", phone: "", email: "", city: "Charter Oak", message: "", company: ""
  });
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [isSubmitted, setIsSubmitted] = useState(false);

  useEffect(() => {
    document.title = "Charter Oak Landscape Construction | Outright Landscape Construction";
    
    const metaDescriptionEl = document.querySelector('meta[name="description"]');
    const metaDescriptionContent = "Professional landscaping, sod installation, and hardscape services in Charter Oak, CA. Local experts you can trust.";
    ...
    const pageUrl = "https://outrightlandscape.com/charter-oak-landscape-construction";
    ...
    try {
      ...
      if (!formData.company) {
        const payload = new URLSearchParams({
          _subject: `New Quote Request — Charter Oak`,
          name: formData.name,
    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="hero relative text-white text-center flex flex-col items-center justify-center min-h-[60vh] py-20 px-4">
        ...
        <div className="relative z-10 flex flex-col items-center gap-y-4">
          <h1 className="hero-h1 text-4xl md:text-6xl font-extrabold leading-tight">
            Charter Oak Landscape Construction & Landscaping Services
          </h1>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Charter Oak's Trusted Landscape Construction Experts</h2>
          <p className="mt-6 text-lg text-gray-700 leading-relaxed">
            At Outright Landscape Construction, we bring years of expertise to homeowners and businesses in Charter Oak. 
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Our Landscape & Hardscape Services in Charter Oak</h2>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold">Why Charter Oak Chooses Us</h2>
            </div>
      ...
      <section className="py-12 bg-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-gray-700">
            Charter Oak, Covina, West Covina, Glendora, Pasadena, Diamond Bar, San Dimas, La Verne, Claremont, Baldwin Park
          </p>
        </div>
      </section>
